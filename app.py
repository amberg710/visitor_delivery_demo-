...
def filter_visitors_by_range(visitors, start_date="", end_date=""):
    filtered = []
    ...
    for v in visitors:
        ...
        try:
            visitor_date = datetime.strptime(date_str, "%Y-%m-%d").date()
        except ValueError:
            continue
